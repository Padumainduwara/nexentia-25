...
"[project]/node_modules/postprocessing/build/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var Pass = class _Pass {
   ...
   */ setDepthTexture(depthTexture) {
        let depthPacking = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BasicDepthPacking"];
    }
    /**
   * Renders this pass.
   *
...
var IdManager = class {
   ...
   * @return This manager.
   */ reset() {
        let initialId = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0;
...
var GlitchEffect = class extends Effect {
   ...
   */ generatePerturbationMap() {
        let value = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 64;
...
var LookupTexture = class _LookupTexture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Data3DTexture"] {
   ...
   */ scaleUp(size) {
        let transferData = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
...
var DepthComparisonMaterial = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ShaderMaterial"] {
   ...
   */ setDepthBuffer(buffer) {
        let depthPacking = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RGBADepthPacking"];
        this.depthBuffer = buffer;
        this.depthPacking = depthPacking;
    }
    /**
...
var TextureEffect = class extends Effect {
   ...
   */ setTextureSwizzleRGBA(r) {
        let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : r, b = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : r, a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : r;
        const rgba = "rgba";
        let swizzle = "";
...
var LUT3dlLoader = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Loader"] {
   ...
   */ load(url) {
        let onLoad = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : ()=>{}, onProgress = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ()=>{}, onError = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
...
var SMAAImageLoader = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Loader"] {
   ...
   */ load() {
        let onLoad = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ()=>{}, onError = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
...
var DepthPickingPass = class extends DepthCopyPass {
   ...
   */ constructor({ depthPacking = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RGBADepthPacking"], mode = DepthCopyMode.SINGLE } = {}){
        if (depthPacking !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RGBADepthPacking"] && depthPacking !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BasicDepthPacking"]) {
            throw new Error("Unsupported depth packing: ".concat(depthPacking));
        }
        super({
            depthPacking
        });
...
function integrateEffect(prefix, effect, data) {
    ...
    if (fragmentShader === void 0) {
        throw new Error("Missing fragment shader (".concat(effect.name, ")"));
    } else if (mainUvExists && (data.attributes & EffectAttribute.CONVOLUTION) !== 0) {
        throw new Error("Effects that transform UVs are incompatible with convolution effects (".concat(effect.name, ")"));
    } else if (!mainImageExists && !mainUvExists) {
        throw new Error("Could not find mainImage or mainUv function (".concat(effect.name, ")"));
    } else {
        ...
        if (mainImageExists) {
            ...
            fragmentMainImage += "".concat(prefix, "MainImage(color0, UV, ");
            ...
            fragmentMainImage += "color0 = blend".concat(blendMode.blendFunction, "(color0, color1, ").concat(blendOpacity, ");\n\n	");
            fragmentHead += "uniform float ".concat(blendOpacity, ";\n\n");
        }
   ...
   */ updateMaterial() {
        ...
        for (const effect of this.effects){
            if (effect.blendMode.blendFunction === BlendFunction.DST) {
                ...
                throw new Error("Convolution effects cannot be merged (".concat(effect.name, ")"));
            } else {
        ...
        for (const blendMode of data.blendModes.values()){
            fragmentHead += blendMode.getShaderCode().replace(blendRegExp, "blend".concat(blendMode.blendFunction)) + "\n";
        }
...
//# sourceMappingURL=node_modules_postprocessing_build_index_40ea3c24.js.map